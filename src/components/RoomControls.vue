    ...
    <div class="controls-container">
        <div class="filters">
            ...
            <div class="filter-group">
                ...
                <select id="equipment-select" @change="onEquipmentChange($event)" class="select-input">
                    <option value="">Sélectionner un équipement</option>
                    <option v-for="equipment in roomStore.equipements" :key="equipment.id" :value="equipment.name"
                ...
                <div v-if="roomStore.selectedEquipments.length > 0" class="selected-equipments">
                    <span v-for="equipment in roomStore.selectedEquipments" :key="equipment" class="equipment-bubble">
                        {{ equipment }}
                        <button @click="removeEquipment(equipment)" class="remove-equipment">
                            ×
                        </button>
                    </span>
            ...
            <div class="filter-group">
                ...
                <select id="capacity-select" :value="roomStore.selectedCapacity" @change="onCapacityChange($event)"
                    class="select-input">
                    <option v-for="roomCapacity in roomCapacities" :key="roomCapacity.value"
            ...
            <div class="filter-group">
                ...
                <select v-if="!roomStore.noRoomsFound" id="room-select" :value="roomStore.selectedRoom?.id || ''"
                    @change="onRoomChange($event)" class="select-input">
                    <option v-for="room in roomStore.filteredRooms" :key="room.id" :value="room.id">
                        {{ room.name }}
                    </option>
                </select>
